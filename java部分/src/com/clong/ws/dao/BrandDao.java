...
public class BrandDao {
	...
	public Integer saveOne(String name, Integer sort) {
		String sql = "INSERT INTO brand (name,sort) VALUES (:name,:sort)";
	...
	public Map<String, Object> getById(Integer id) {
		String sql = "SELECT id,name,sort FROM brand WHERE id = :id";
	...
	public List<Map<String, Object>> getPageLimit(Integer start, Integer length) {
		String sql = "SELECT id,name,sort FROM brand ORDER BY sort ASC LIMIT :start,:length";
		Map<String, Integer> paramMap = new HashMap<String, Integer>();
	...
	public Map<String, Object> getAllCount() {
		String sql = "SELECT count(*) AS allCount FROM brand";
	...
	public Map<String, Object> sortCount(Integer sort, Integer id) {
		String sql = "SELECT count(*) AS sortCount FROM brand WHERE sort = :sort AND id != :id";
		Map<String, Integer> paramMap = new HashMap<String, Integer>();
		paramMap.put("sort", sort);
		paramMap.put("id", id);
		Map<String, Object> rs = this.namedParameterJdbcTemplate.queryForMap(sql, paramMap);
	...
	public Map<String, Object> sortCount(Integer sort) {
		String sql = "SELECT count(*) AS sortCount FROM brand WHERE sort = :sort";
		Map<String, Integer> paramMap = new HashMap<String, Integer>();
		paramMap.put("sort", sort);
		Map<String, Object> rs = this.namedParameterJdbcTemplate.queryForMap(sql, paramMap);
		return rs;
	...
	public Integer modifyById(Integer id, String name, Integer sort) {
		String sql = "UPDATE brand SET name = :name,sort = :sort WHERE id = :id";
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("id", id);
		paramMap.put("name", name);
		paramMap.put("sort", sort);
	...
	public List<Map<String, Object>> getAll() {
		String sql = "SELECT id,name,sort FROM brand ORDER BY sort ASC";
		Map<String, Integer> paramMap = new HashMap<String, Integer>();
		List<Map<String, Object>> rs = this.namedParameterJdbcTemplate.queryForList(sql, paramMap);
		return rs;
	}
